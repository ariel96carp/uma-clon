const Benefits = () => (
    <section className="section">
        <div className="page-container">
            <h2 className="mb-3 font-bold text-xl">¿Por qué sumarte a ÜMA?</h2>
            <p className="mb-4">
                🚀 Porque vas a poder potenciar tu carrera profesional trabajando con las mejores
                tecnologías, por objetivos y con metodología MVP que nos da la libertad para tomar
                nuestras propias decisiones!
                <br />
                🤩 Porque vas a ser parte de un equipo interdisciplinario formado por Data Science,
                Ingenieros, B.I. y profesionales de la salud que trabaja en la vanguardia en
                tecnologías!
            ...
            <ul className="section-container flex flex-col gap-1 mb-4">
                ...
                <li>
                    … y mucho más, pero te lo contamos en la entrevista 😎
                </li>
            </ul>
            <p>
                Si sos del team co-workers, tenemos oficinas abiertas 7x24 en el barrio de Coghlan
                (Pet Friendly ❤️🐶)
            </p>
        </div>
    </section>
